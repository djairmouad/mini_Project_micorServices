...
const Button:React.FC<{content:string,width:string,buttonColor:string,onClick:()=>void,textColor:string | undefined,borderColor:string,hoverColor:string,type:"button" | "submit" | "reset" }>=({type,content,buttonColor,onClick,width,textColor,borderColor,hoverColor})=>{
